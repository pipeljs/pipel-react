 ...
 * ```
 */
export function usePipel<T>(initialValue: T): [T, Stream<T>]

export function usePipel<T>(initialValue: T | PromiseLike<T>): [T | undefined, Stream<T>]

export function usePipel<T>(stream$: Stream<T>): [T, Stream<T>]

export function usePipel<T>(observable$: Observable<T>): [T | undefined, Observable<T>]
